package dev.brighten.anticheat.check.impl.regular.movement.jump;
...
@CheckInfo(name = "Jump (A)", description = "Checks for invalid jump motion.",
        checkType = CheckType.JUMP, punishVL = 10, executable = true)
@Cancellable
